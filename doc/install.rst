...
.. code-block:: bash
    ...
    pip install git+https://github.com/wdk-docs/sphinxcontrib-disqus.git

Clone and Install
=================

Lastly you can also just clone the repo and install from it. Usually you only need to do this if you plan on
`contributing <https://github.com/wdk-docs/sphinxcontrib-disqus/blob/master/CONTRIBUTING.md>`_ to the project.

.. code-block:: bash

    git clone https://github.com/wdk-docs/sphinxcontrib-disqus.git
